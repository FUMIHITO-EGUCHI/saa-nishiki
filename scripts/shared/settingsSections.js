...
export const DEFAULT_SETTINGS = Object.freeze({
    ...
    style_weight_plans: [],
    negative_left_weight_plans: [],
    negative_right_weight_plans: [],
    ...
    negative_left_batch: { enabled: false, count: 4 },
    negative_right_batch: { enabled: false, count: 4 },
    ...
    // how long the pod keeps that model in VRAM after a call ('10m', '1h', 0 = unload at once)
    ai_pod_keep_alive: '10m',
...
export const SECTION_KEYS = Object.freeze({
    app: Object.freeze([
        ...
        'api_pod_ssh_enable', 'api_pod_ssh_target', 'api_pod_ssh_key', 'api_pod_ssh_comfy_port', 'pod_image_save_dir', 'api_pod_runpod_api_key', 'api_pod_runpod_pod_id',
